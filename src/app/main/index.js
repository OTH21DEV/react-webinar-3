...
//test change btn name from auth state 
  return (
    <PageLayout>
      <BtnLogin name={select.userName} toLogin={"/login"} toProfile={"/profile"} onLogOut={callbacks.onLogOut} onReset={callbacks.onReset} ></BtnLogin>
      <Head title={t("title")}>
        <LocaleSelect />
      </Head>
      <Navigation />
